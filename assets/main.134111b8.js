var f=(r,t)=>()=>(t||r((t={exports:{}}).exports,t),t.exports);var v=f((B,c)=>{(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function e(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=e(i);fetch(i.href,o)}})();class g{constructor(){var t;this.tg=(t=window.Telegram)==null?void 0:t.WebApp,this.isInitialized=!1,this.user=null,this.init()}init(){var t;this.tg?(this.tg.ready(),this.tg.expand(),this.user=(t=this.tg.initDataUnsafe)==null?void 0:t.user,this.isInitialized=!0,console.log("Telegram SDK initialized",this.user)):(console.warn("Telegram WebApp not available"),this.user={id:123456789,first_name:"Test",last_name:"User",username:"testuser",photo_url:null})}getUser(){return this.user}getUserName(){return this.user?this.user.username?"@"+this.user.username:this.user.first_name+(this.user.last_name?" "+this.user.last_name:""):"Гость"}getUserPhoto(){var t;return((t=this.user)==null?void 0:t.photo_url)||null}getUserId(){var t;return((t=this.user)==null?void 0:t.id)||null}getReferralCode(){const t=new URLSearchParams(window.location.search);return t.get("ref")||t.get("start")}createReferralLink(t){return`https://t.me/ClickerSpaceBot?start=${t}`}sendData(t){this.tg&&this.tg.sendData(JSON.stringify(t))}showMainButton(t,e){this.tg&&(this.tg.MainButton.text=t,this.tg.MainButton.show(),this.tg.MainButton.onClick(e))}hideMainButton(){this.tg&&this.tg.MainButton.hide()}showAlert(t){this.tg?this.tg.showAlert(t):alert(t)}showConfirm(t,e){if(this.tg)this.tg.showConfirm(t,e);else{const s=confirm(t);e(s)}}hapticFeedback(t="impact",e="medium"){var s;(s=this.tg)!=null&&s.HapticFeedback&&(t==="impact"?this.tg.HapticFeedback.impactOccurred(e):t==="notification"?this.tg.HapticFeedback.notificationOccurred(e):t==="selection"&&this.tg.HapticFeedback.selectionChanged())}buyWithStars(t,e){var s;(s=this.tg)!=null&&s.invokeCustomMethod?(this.tg.invokeCustomMethod("web_app_trigger_haptic_feedback",{type:"impact",impact_style:"light"}),this.showConfirm(`Купить за ${t} звезд?`,i=>{i?(this.hapticFeedback("notification","success"),e(!0)):e(!1)})):(this.showAlert("Покупка за звезды доступна только в Telegram"),e(!1))}close(){this.tg&&this.tg.close()}}class y{constructor(t){this.tg=t,this.referrals=[],this.referralEarnings=0,this.referralPercentage=.02,this.init()}init(){this.loadReferralData(),this.checkReferralCode()}checkReferralCode(){const t=this.tg.getReferralCode(),e=this.tg.getUserId();t&&e&&t!==e.toString()&&this.registerReferral(t,e)}registerReferral(t,e){if(this.getReferralData(e))return console.log("User already has a referrer"),!1;const i={referrerId:t,referredUserId:e,timestamp:Date.now(),totalEarnings:0};return localStorage.setItem(`referral_${e}`,JSON.stringify(i)),this.showReferralWelcome(t),!0}getReferralData(t){try{const e=localStorage.getItem(`referral_${t}`);return e?JSON.parse(e):null}catch(e){return console.error("Error loading referral data:",e),null}}addReferralEarning(t,e){const s=this.getReferralData(t);if(!s)return 0;const i=Math.floor(e*this.referralPercentage);return s.totalEarnings+=e,localStorage.setItem(`referral_${t}`,JSON.stringify(s)),this.addReferrerBonus(s.referrerId,i),i}addReferrerBonus(t,e){const s=this.tg.getUserId();t===(s==null?void 0:s.toString())&&(this.referralEarnings+=e,this.saveReferralData(),e>0&&this.showReferralBonus(e))}getUserReferrals(){const t=this.tg.getUserId();if(!t)return[];const e=[];for(let s=0;s<localStorage.length;s++){const i=localStorage.key(s);if(i&&i.startsWith("referral_"))try{const o=JSON.parse(localStorage.getItem(i));o.referrerId===t.toString()&&e.push({userId:o.referredUserId,timestamp:o.timestamp,totalEarnings:o.totalEarnings,bonus:Math.floor(o.totalEarnings*this.referralPercentage)})}catch(o){console.error("Error parsing referral data:",o)}}return e.sort((s,i)=>i.timestamp-s.timestamp)}getReferralLink(){const t=this.tg.getUserId();return t?this.tg.createReferralLink(t):null}copyReferralLink(){const t=this.getReferralLink();return t?(navigator.clipboard?navigator.clipboard.writeText(t).then(()=>{this.showNotification("Реферальная ссылка скопирована!","success")}).catch(()=>{this.fallbackCopyTextToClipboard(t)}):this.fallbackCopyTextToClipboard(t),!0):!1}fallbackCopyTextToClipboard(t){const e=document.createElement("textarea");e.value=t,e.style.top="0",e.style.left="0",e.style.position="fixed",document.body.appendChild(e),e.focus(),e.select();try{document.execCommand("copy"),this.showNotification("Реферальная ссылка скопирована!","success")}catch(s){console.error("Fallback: Oops, unable to copy",s),this.showNotification("Не удалось скопировать ссылку","error")}document.body.removeChild(e)}showReferralWelcome(t){this.showNotification(`Добро пожаловать! Вас пригласил пользователь ${t}`,"success")}showReferralBonus(t){this.showNotification(`Реферальный бонус: +${this.formatNumber(t)}`,"success")}getReferralStats(){const t=this.getUserReferrals(),e=t.length,s=t.reduce((o,a)=>o+a.totalEarnings,0),i=t.reduce((o,a)=>o+a.bonus,0);return{totalReferrals:e,totalEarnings:s,totalBonus:i,referralEarnings:this.referralEarnings}}saveReferralData(){const t={referralEarnings:this.referralEarnings,timestamp:Date.now()};localStorage.setItem("referralSystemData",JSON.stringify(t))}loadReferralData(){try{const t=localStorage.getItem("referralSystemData");if(t){const e=JSON.parse(t);this.referralEarnings=e.referralEarnings||0}}catch(t){console.error("Error loading referral system data:",t)}}formatNumber(t){return isNaN(t)||t===null||t===void 0?"0":(t=Math.floor(t),t<0?"-"+this.formatNumber(Math.abs(t)):t>=1e12?(t/1e12).toFixed(2)+"T":t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e3?(t/1e3).toFixed(1)+"K":t.toString())}showNotification(t,e="info"){const s=document.createElement("div");s.className=`notification ${e}`,s.textContent=t;const i={success:"#4CAF50",error:"#f44336",warning:"#ff9800",info:"#2196F3"};s.style.cssText=`
        ...
        `,document.body.appendChild(s),setTimeout(()=>{s.style.animation="slideUp 0.3s ease-out",setTimeout(()=>s.remove(),300)},3e3)}}class b{constructor(){this.imageCache=new Map,this.basePaths=["./assets/","./Plantes/Sun System/","/assets/","/Plantes/Sun System/","./public/Plantes/Sun System/","/public/Plantes/Sun System/"],this.planetImages={Earth:["Earth.png","earth.png"],Mars:["Mars.png","mars.png"],Jupiter:["Jupiter.png","jupiter.png"],Saturn:["Jupiter.png","saturn.png"],Uranus:["Jupiter.png","uranus.png"],Neptune:["Jupiter.png","neptune.png"],Sun:["sun.png","Sun.png"]}}async checkImageExists(t){return new Promise(e=>{const s=new Image;s.onload=()=>e(!0),s.onerror=()=>e(!1),s.src=t})}async findPlanetImage(t){if(this.imageCache.has(t))return this.imageCache.get(t);const e=this.planetImages[t]||[t+".png"];for(const i of this.basePaths)for(const o of e){const a=i+o;try{if(await this.checkImageExists(a))return console.log(`Found image for ${t}: ${a}`),this.imageCache.set(t,a),a}catch{continue}}const s=`./assets/${e[0]}`;return console.warn(`Image not found for ${t}, using fallback: ${s}`),this.imageCache.set(t,s),s}async discoverImages(){console.log("Discovering available planet images...");const t={};for(const e of Object.keys(this.planetImages)){const s=await this.findPlanetImage(e);t[e]=s}return console.log("Image discovery complete:",t),t}async preloadImages(t){const e=t.map(s=>new Promise((i,o)=>{const a=new Image;a.onload=()=>i(s),a.onerror=()=>o(new Error(`Failed to load: ${s}`)),a.src=s}));try{const s=await Promise.allSettled(e),i=s.filter(a=>a.status==="fulfilled").map(a=>a.value),o=s.filter(a=>a.status==="rejected").map(a=>a.reason.message);return o.length>0&&console.warn("Some images failed to load:",o),console.log(`Successfully preloaded ${i.length} images`),i}catch(s){return console.error("Error preloading images:",s),[]}}getCachedImage(t){return this.imageCache.get(t)||null}clearCache(){this.imageCache.clear()}}const S=new b;class x{constructor(){this.imageLoader=S,this.planets=this.initializePlanets(),this.currentPlanet="earth",this.unlockedPlanets=["earth"],this.initializeImages()}initializePlanets(){return{earth:{name:"Земля",description:"Наш родной дом",price:0,boost:1,image:null,imageName:"Earth",glow:"radial-gradient(circle, rgba(74, 144, 226, 0.3) 0%, transparent 70%)",unlocked:!0},mars:{name:"Марс",description:"Красная планета воинов",price:1e3,boost:1.5,image:null,imageName:"Mars",glow:"radial-gradient(circle, rgba(255, 100, 100, 0.3) 0%, transparent 70%)",unlocked:!1},jupiter:{name:"Юпитер",description:"Газовый гигант богатства",price:5e3,boost:2,image:null,imageName:"Jupiter",glow:"radial-gradient(circle, rgba(255, 150, 50, 0.3) 0%, transparent 70%)",unlocked:!1},saturn:{name:"Сатурн",description:"Планета с кольцами",price:1e4,boost:3.5,image:null,imageName:"Saturn",glow:"radial-gradient(circle, rgba(255, 200, 100, 0.3) 0%, transparent 70%)",unlocked:!1},uranus:{name:"Уран",description:"Ледяной гигант мудрости",price:25e3,boost:4,image:null,imageName:"Uranus",glow:"radial-gradient(circle, rgba(100, 200, 255, 0.3) 0%, transparent 70%)",unlocked:!1},neptune:{name:"Нептун",description:"Далекий страж океанов",price:5e4,boost:5,image:null,imageName:"Neptune",glow:"radial-gradient(circle, rgba(50, 100, 255, 0.3) 0%, transparent 70%)",unlocked:!1},sun:{name:"Солнце",description:"Источник всей энергии",price:1e5,boost:5.5,image:null,imageName:"Sun",glow:"radial-gradient(circle, rgba(255, 200, 0, 0.5) 0%, transparent 70%)",unlocked:!1}}}async initializeImages(){console.log("Initializing planet images...");try{const t=await this.imageLoader.discoverImages();for(const[s,i]of Object.entries(this.planets)){const o=t[i.imageName];o?(i.image=o,console.log(`Set image for ${s}: ${o}`)):(console.warn(`No image found for ${s} (${i.imageName})`),i.image=`./assets/${i.imageName}.png`)}this.updatePlanetVisual(this.currentPlanet);const e=Object.values(this.planets).map(s=>s.image).filter(Boolean);await this.imageLoader.preloadImages(e),console.log("Planet images initialized successfully")}catch(t){console.error("Error initializing planet images:",t),this.setFallbackImages()}}setFallbackImages(){console.log("Setting fallback images...");for(const[t,e]of Object.entries(this.planets))e.image=`./assets/${e.imageName}.png`;this.updatePlanetVisual(this.currentPlanet)}addPlanet(t,e){this.planets[t]={name:e.name,description:e.description,price:e.price,boost:e.boost,image:e.image,glow:e.glow||"radial-gradient(circle, rgba(255, 255, 255, 0.3) 0%, transparent 70%)",unlocked:!1}}getPlanet(t){return this.planets[t]||null}getAllPlanets(){return this.planets}getUnlockedPlanets(){return this.unlockedPlanets}isPlanetUnlocked(t){return this.unlockedPlanets.includes(t)}unlockPlanet(t){return this.planets[t]?this.unlockedPlanets.includes(t)?!1:(this.unlockedPlanets.push(t),this.planets[t].unlocked=!0,!0):(console.error(`Planet ${t} does not exist`),!1)}changePlanet(t){return this.isPlanetUnlocked(t)?(this.currentPlanet=t,this.updatePlanetVisual(t),!0):(console.error(`Planet ${t} is not unlocked`),!1)}updatePlanetVisual(t){const e=this.planets[t];if(!e)return;const s=document.getElementById("planet-earth");if(!s)return;const i=s.querySelector(".planet-surface"),o=s.querySelector(".planet-glow");i&&e.image&&(i.style.backgroundImage=`url('${e.image}')`,console.log(`Updated planet visual for ${t}: ${e.image}`)),o&&(o.style.background=e.glow)}async getPlanetImage(t){const e=this.planets[t];if(!e)return null;if(e.image)return e.image;try{const s=await this.imageLoader.findPlanetImage(e.imageName);return e.image=s,s}catch(s){return console.error(`Error finding image for ${t}:`,s),null}}getCurrentPlanet(){return this.currentPlanet}getCurrentPlanetBoost(){const t=this.planets[this.currentPlanet],e=t?t.boost:1;return console.log(`Current planet ${this.currentPlanet} boost: ${e}`),e}getTotalPlanetBoost(){let t=1;return this.unlockedPlanets.forEach(e=>{const s=this.planets[e];if(s){if(e==="earth")return;t+=s.boost-1}}),console.log(`Total planet boost: ${t} (unlocked planets: ${this.unlockedPlanets.join(", ")})`),t}buyPlanet(t,e){const s=this.planets[t];return s?this.isPlanetUnlocked(t)?(this.changePlanet(t),{success:!0,message:`Переключились на планету ${s.name}`,cost:0}):e<s.price?{success:!1,message:`Недостаточно денег! Нужно ${this.formatNumber(s.price)}`}:(this.unlockPlanet(t),this.changePlanet(t),{success:!0,message:`Планета ${s.name} разблокирована!`,cost:s.price}):{success:!1,message:"Планета не найдена"}}getMapData(){return Object.keys(this.planets).map(t=>{const e=this.planets[t];return{id:t,name:e.name,description:e.description,price:e.price,boost:e.boost,image:e.image,unlocked:this.isPlanetUnlocked(t),current:t===this.currentPlanet}})}saveState(){return{currentPlanet:this.currentPlanet,unlockedPlanets:[...this.unlockedPlanets]}}loadState(t){t.currentPlanet&&(this.currentPlanet=t.currentPlanet),t.unlockedPlanets&&(this.unlockedPlanets=[...t.unlockedPlanets],this.unlockedPlanets.forEach(e=>{this.planets[e]&&(this.planets[e].unlocked=!0)})),this.updatePlanetVisual(this.currentPlanet)}formatNumber(t){return isNaN(t)||t===null||t===void 0?"0":(t=Math.floor(t),t<0?"-"+this.formatNumber(Math.abs(t)):t>=1e12?(t/1e12).toFixed(2)+"T":t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e3?(t/1e3).toFixed(1)+"K":t.toString())}}class w{constructor(){this.activeBoosts=new Map,this.boostHistory=[],this.init()}init(){this.loadBoostData(),this.startBoostTimer()}applyBoost(t,e,s,i="unknown"){const o=this.generateBoostId(),a={id:o,type:t,multiplier:e,duration:s,source:i,startTime:Date.now(),endTime:Date.now()+s};return this.activeBoosts.set(o,a),this.boostHistory.push({...a,applied:!0}),this.showBoostNotification(a),this.updateBoostDisplay(),setTimeout(()=>{this.removeBoost(o)},s),o}removeBoost(t){const e=this.activeBoosts.get(t);e&&(this.activeBoosts.delete(t),this.showBoostEndNotification(e),this.updateBoostDisplay())}getActiveBoosts(){const t=Date.now();for(const[e,s]of this.activeBoosts)t>=s.endTime&&this.activeBoosts.delete(e);return Array.from(this.activeBoosts.values())}getClickMultiplier(){let t=1;return this.getActiveBoosts().forEach(s=>{(s.type==="click"||s.type==="all")&&(t*=s.multiplier)}),t}getAutoMultiplier(){let t=1;return this.getActiveBoosts().forEach(s=>{(s.type==="auto"||s.type==="all")&&(t*=s.multiplier)}),t}applyAdBoost(){return this.applyBoost("all",2,6e4,"advertisement")}applyFreeBoost(){const t=localStorage.getItem("lastFreeBoost"),e=Date.now(),s=18e5;return t&&e-parseInt(t)<s?{success:!1,message:`Бесплатный буст будет доступен через ${Math.ceil((s-(e-parseInt(t)))/6e4)} мин`}:(localStorage.setItem("lastFreeBoost",e.toString()),{success:!0,message:"Бесплатный буст x1.5 активирован на 15 секунд!",boostId:this.applyBoost("all",1.5,15e3,"free")})}isFreeBoostAvailable(){const t=localStorage.getItem("lastFreeBoost");if(!t)return!0;const e=Date.now(),s=18e5;return e-parseInt(t)>=s}getFreeBoostCooldown(){const t=localStorage.getItem("lastFreeBoost");if(!t)return 0;const i=18e5-(Date.now()-parseInt(t));return Math.max(0,i)}generateBoostId(){return"boost_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}showBoostNotification(t){const e=`Буст x${t.multiplier} активирован на ${Math.ceil(t.duration/1e3)} сек!`;this.showNotification(e,"success")}showBoostEndNotification(t){this.showNotification("Буст закончился","info")}updateBoostDisplay(){this.updateBoostTimer(),this.updateFreeBoostButton()}updateBoostTimer(){const t=this.getActiveBoosts(),e=document.getElementById("boost-timer");if(t.length===0){e&&e.remove();return}const s=t.reduce((a,n)=>n.multiplier>a.multiplier?n:a),i=Math.ceil((s.endTime-Date.now())/1e3);if(i<=0){e&&e.remove();return}let o=e;o||(o=document.createElement("div"),o.id="boost-timer",o.className="boost-timer-display",o.style.cssText=`
                position: fixed;
                top: 70px;
                right: 20px;
        ...
        `;const i=this.planetEarth.getBoundingClientRect(),o=t.clientX-i.left,a=t.clientY-i.top;s.style.left=o+"px",s.style.top=a+"px",this.planetEarth.appendChild(s),setTimeout(()=>s.remove(),1e3)}buyUpgrade(t){if(this.clickDebounce)return;this.clickDebounce=!0,setTimeout(()=>this.clickDebounce=!1,200);const e=this.upgradePrices[t];if(t==="click"&&this.money>=e)this.money-=e,this.clickValue+=1,this.upgradePrices.click=Math.floor(e*1.5),this.soundSystem.playUpgradeSound(),this.telegramSDK.hapticFeedback("notification","success"),this.showNotification("Клик улучшен! +1 за клик","success");else if(t==="auto"&&this.money>=e)this.money-=e,this.baseAutoClickValue+=1,this.updateBoostState(),this.upgradePrices.auto=Math.floor(e*1.5),this.soundSystem.playUpgradeSound(),this.telegramSDK.hapticFeedback("notification","success"),this.showNotification("Автоклик улучшен! +1/сек","success");else{this.soundSystem.playErrorSound(),this.telegramSDK.hapticFeedback("notification","error"),this.showNotification("Недостаточно денег!","error"),this.clickDebounce=!1;return}this.updateShopDisplay(),this.updateDisplay(),this.saveGame()}updateBoostState(){const t=this.planetSystem.getTotalPlanetBoost(),e=this.boostSystem.getAutoMultiplier();this.autoClickValue=Math.floor(this.baseAutoClickValue*t*e),this.updateDisplay(),this.saveGame()}buyPlanetFromMap(t,e){const s=this.planetSystem.buyPlanet(t,this.money);if(s.success){this.money-=s.cost;const i=document.querySelector(`.map-item[data-planet="${t}"]`);if(i&&s.cost>0){i.classList.remove("locked");const o=i.querySelector(".map-status");o&&(o.textContent="Доступна",o.classList.remove("locked"),o.classList.add("active"))}this.updateBoostState(),this.soundSystem.playUnlockSound(),this.telegramSDK.hapticFeedback("notification","success"),this.showNotification(s.message,"success"),this.updateDisplay(),this.saveGame()}else this.soundSystem.playErrorSound(),this.telegramSDK.hapticFeedback("notification","error"),this.showNotification(s.message,"error")}buyDonation(t){this.money>=t?(this.money-=t,this.soundSystem.playPurchaseSound(),this.telegramSDK.hapticFeedback("notification","success"),this.showDonationEffect(),this.showNotification(`Спасибо за донат ${this.formatNumber(t)}!`,"success"),this.updateDisplay(),this.saveGame()):(this.soundSystem.playErrorSound(),this.telegramSDK.hapticFeedback("notification","error"),this.showNotification("Недостаточно денег для доната!","error"))}showDonationEffect(){for(let e=0;e<20;e++)setTimeout(()=>{const s=document.createElement("div");s.innerHTML="⭐",s.style.cssText=`
            ...
            `,s.unlocked?i.onclick=()=>{this.planetSystem.changePlanet(s.id),this.updateBoostState(),this.updateMapDisplay(),this.updateDisplay()}:i.onclick=()=>this.buyPlanetFromMap(s.id,s.price),e.appendChild(i)}}}updateShopDisplay(){const t=document.getElementById("click-price"),e=document.getElementById("auto-price");t&&(t.textContent=this.formatNumber(this.upgradePrices.click)),e&&(e.textContent=this.formatNumber(this.upgradePrices.auto));const s=document.getElementById("satellite-price"),i=document.getElementById("spaceship-price");s&&this.upgradePrices.satellite&&(s.textContent=this.formatNumber(this.upgradePrices.satellite)),i&&this.upgradePrices.spaceship&&(i.textContent=this.formatNumber(this.upgradePrices.spaceship)),this.boostSystem.updateFreeBoostButton()}updateDisplay(){if(this.moneyDisplay&&(this.moneyDisplay.textContent=this.formatNumber(Math.floor(this.money))),this.incomeDisplay){const t=this.formatNumber(this.autoClickValue),e=this.boostSystem.getActiveBoosts(),s=this.planetSystem.getTotalPlanetBoost();let i=t,o=[];if(s>1&&o.push(`планеты x${s.toFixed(1)}`),e.length>0){const a=this.boostSystem.getAutoMultiplier();o.push(`буст x${a.toFixed(1)}`)}o.length>0?this.incomeDisplay.innerHTML=`<span style="color: #4CAF50; font-weight: bold;">${i} (${o.join(", ")})</span>`:this.incomeDisplay.textContent=i}}formatNumber(t){return isNaN(t)||t===null||t===void 0?"0":(t=Math.floor(t),t<0?"-"+this.formatNumber(Math.abs(t)):t>=1e12?(t/1e12).toFixed(2)+"T":t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e3?(t/1e3).toFixed(1)+"K":t.toString())}capitalizeFirstLetter(t){return t.charAt(0).toUpperCase()+t.slice(1)}buyRocketBoost(){this.money>=100?(this.money-=100,this.clickValue*=2,this.soundSystem.playUpgradeSound(),this.telegramSDK.hapticFeedback("notification","success"),this.showNotification("Ракетный ускоритель установлен! Клик x2","success"),this.updateDisplay(),this.saveGame()):(this.soundSystem.playErrorSound(),this.showNotification("Недостаточно денег!","error"))}buySatellite(){this.upgradePrices.satellite||(this.upgradePrices.satellite=100);const t=this.upgradePrices.satellite;if(this.money>=t){this.money-=t,this.clickValue+=2,this.upgradePrices.satellite=Math.floor(t*1.5);const e=document.getElementById("satellite-price");e&&(e.textContent=this.formatNumber(this.upgradePrices.satellite));const s=document.querySelector('[data-upgrade="satellite"] .shop-buy-btn');s&&(s.textContent="Купить"),this.soundSystem.playUpgradeSound(),this.telegramSDK.hapticFeedback("notification","success"),this.showNotification("Спутник запущен! Клик +2","success"),this.updateDisplay(),this.saveGame()}else this.soundSystem.playErrorSound(),this.telegramSDK.hapticFeedback("notification","error"),this.showNotification(`Недостаточно денег! Нужно ${this.formatNumber(t)}`,"error")}buySpaceship(){this.upgradePrices.spaceship||(this.upgradePrices.spaceship=500);const t=this.upgradePrices.spaceship;if(this.money>=t){this.money-=t,this.baseAutoClickValue+=1,this.upgradePrices.spaceship=Math.floor(t*1.5);const e=document.getElementById("spaceship-price");e&&(e.textContent=this.formatNumber(this.upgradePrices.spaceship));const s=document.querySelector('[data-upgrade="spaceship"] .shop-buy-btn');s&&(s.textContent="Купить"),this.updateBoostState(),this.soundSystem.playUpgradeSound(),this.telegramSDK.hapticFeedback("notification","success"),this.showNotification("Космический корабль запущен! +1/сек","success"),this.updateDisplay(),this.saveGame()}else this.soundSystem.playErrorSound(),this.telegramSDK.hapticFeedback("notification","error"),this.showNotification(`Недостаточно денег! Нужно ${this.formatNumber(t)}`,"error")}buyWithStars(){this.telegramSDK.buyWithStars(1,s=>{s?(this.money+=1e4,this.soundSystem.playUpgradeSound(),this.showNotification(`Получено ${this.formatNumber(1e4)} монет за 1 звезду!`,"success"),this.updateDisplay(),this.saveGame()):this.showNotification("Покупка отменена","info")})}updateFriendsDisplay(){const t=document.getElementById("friends-panel");if(!t)return;const e=t.querySelector(".panel-content");if(!e)return;const s=this.referralSystem.getReferralStats(),i=this.referralSystem.getUserReferrals(),o=this.referralSystem.getReferralLink();e.innerHTML=`
...
`;document.head.appendChild(p);"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(r=>{console.log("SW registered: ",r)}).catch(r=>{console.log("SW registration failed: ",r)})});let l=null;document.addEventListener("DOMContentLoaded",()=>{l=new h,window.addEventListener("beforeunload",()=>{l&&l.saveGame()}),window.addEventListener("unload",()=>{l&&l.destroy()})});typeof c<"u"&&c.exports&&(c.exports=h)});export default v();
